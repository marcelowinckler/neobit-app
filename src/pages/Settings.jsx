      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex items-center gap-2">
            <button onClick={onSave} className="px-3 py-2 text-sm rounded-md bg-brand-600 dark:bg-gray-700 text-white">Salvar preferências</button>
        ...
        <div className="bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            <button
              className={`px-3 py-2 text-sm rounded-md border bg-white dark:bg-gray-800 dark:text-gray-100 hover:bg-gray-50 ${theme === 'light' ? 'ring-2 ring-brand-500 dark:ring-gray-700' : ''}`}
              onClick={() => setTheme('light')}
            >{t('light')}</button>
            <button
              className={`px-3 py-2 text-sm rounded-md border bg-white dark:bg-gray-800 dark:text-gray-100 hover:bg-gray-50 ${theme === 'dark' ? 'ring-2 ring-brand-500 dark:ring-gray-700' : ''}`}
